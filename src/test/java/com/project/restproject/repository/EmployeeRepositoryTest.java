...
public class EmployeeRepositoryTest {
    ...
    public void testSave() throws Exception{
        Employee newEmployee = new Employee ("testFirstName", "testLastName");
    ...
    public void testDelete() throws Exception{
        Employee newEmployee_1 = new Employee ("testFirstName_1", "testLastName_1");

        employeeRepository.save(newEmployee_1);

        Optional<Employee> savedEmployee = employeeRepository.getByFirstName("testFirstName_1");
        Assert.assertEquals(newEmployee_1, savedEmployee.get());
        Long id = savedEmployee.get().getId();
        employeeRepository.deleteById(id);

        Optional<Employee> actualEmployee = employeeRepository.getByFirstName("testFirstName_1");
    ...
    public void testGet() throws Exception{
        Employee newEmployee_2 = new Employee ("testFirstName_2", "testLastName_2");

        employeeRepository.save(newEmployee_2);
        Optional<Employee> actualEmployee = employeeRepository.getByFirstName("testFirstName_2");
